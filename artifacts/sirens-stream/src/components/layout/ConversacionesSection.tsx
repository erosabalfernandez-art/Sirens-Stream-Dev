...
const conversaciones: Conversacion[] = [
  { src: "/images/conversaciones/conv-1.jpg", alt: "Conversación streamer 1" },
  { src: "/images/conversaciones/conv-2.jpg", alt: "Conversación streamer 2" },
  { src: "/images/conversaciones/conv-3.jpg", alt: "Conversación streamer 3" },
  { src: "/images/conversaciones/conv-4.jpg", alt: "Conversación streamer 4" },
  { src: "/images/conversaciones/conv-5.jpg", alt: "Conversación streamer 5" },
  { src: "/images/conversaciones/conv-6.jpg", alt: "Conversación streamer 6" },
  { src: "/images/conversaciones/conv-7.jpg", alt: "Conversación streamer 7" },
  { src: "/images/conversaciones/conv-8.jpg", alt: "Conversación streamer 8" },
];
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2">
        {items.map((_, i) => (
          <button
            ...
            className={`h-2 rounded-full transition-all ${i === current ? "bg-pink-400 w-4" : "bg-white/30 w-2"}`}
          />
        ))}
      </div>
    </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {conversaciones.map((c, i) => (
              <button
                ...
                className="rounded-2xl overflow-hidden border border-white/10 bg-[#0d0d1e] hover:border-pink-500/40 transition-all group cursor-pointer"
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-8 bg-gradient-to-t from-[#0d0d1e] to-transparent" />
                </div>
                <div className="px-3 pb-3 pt-1.5 flex items-center gap-0.5">
                  {[...Array(5)].map((_, j) => (
